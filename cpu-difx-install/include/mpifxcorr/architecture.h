...
#define vectorCos_f32(src, dest, length)                                    ippsCos_32f_A21(src, dest, length)
...
#define vectorSin_f32(src, dest, length)                                    ippsSin_32f_A21(src, dest, length)

#define vectorSinCos_f32(src, sin, cos, length)                             ippsSinCos_32f_A21(src, sin, cos, length)
